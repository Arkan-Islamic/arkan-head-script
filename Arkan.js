            ...
            panels.forEach((panel) => {
              if (panel.querySelector("img")) {
                ...
                organizedCategories.forEach((cat) => {
                  ...
                  path.setAttribute(
                    "d",
                    "M13.22 19.03a.75.75 0 0 0 1.06 0l6.25-6.25a.75.75 0 0 0 0-1.06l-6.25-6.25a.749.749 0 0 0-1.275.326.749.749 0 0 0 .215.734l4.97 4.97H3.75a.75.75 0 0 0 0 1.5h14.44l-4.97 4.97a.75.75 0 0 0 0 1.06Z"
                  );
